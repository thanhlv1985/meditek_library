...
var client = redis.createClient({ host: 'redis-redisys.jozjfj.0001.apse2.cache.amazonaws.com', port: 6378 });
//var client = redis.createClient({host : 'localhost', port : 6378});
